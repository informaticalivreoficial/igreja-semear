    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col justify-between p-12"
        ...
        <div class="relative z-10">
            ...
            <h2 class="text-4xl font-bold text-white mb-4 leading-tight" style="font-family: 'Georgia', serif;">
                Venha fazer<br>
                <span style="color: #c4a84a;">parte da nossa</span><br>
                <span style="color: #c4a84a;">comunidade</span>
            </h2>
            <p class="text-base leading-relaxed" style="color: rgba(255,255,255,0.6); max-width: 320px; font-style: italic;">
                "Onde há unidade, Deus ordena a bênção."<br>
                <span class="text-xs" style="color: rgba(196,168,74,0.5);">Salmo 133:1</span>
            </p>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="mb-8 text-center lg:text-left">
                ...
                <p class="text-sm" style="color: #8a7a6b;">
                    Já possui cadastro?
                    <a href="{{ route('login') }}" wire:navigate style="color: #c4a84a; font-weight: 600;">Faça login</a>
                </p>
            </div>
            ...
            @if ($errors->any())
                <div class="flex items-center gap-3 px-4 py-3 rounded-xl mb-6" style="background: rgba(180,60,60,0.08); border: 1px solid rgba(180,60,60,0.2);">
                    ...
                    <p class="text-sm" style="color: #b43c3c;">Por favor, corrija os erros abaixo</p>
                </div>
            @endif
            ...
            <form wire:submit="register" class="space-y-4">
                ...
                <div class="flex flex-col gap-1.5">
                    <label class="text-sm font-semibold" style="color: #1a2e1a; font-family: 'Georgia', serif;">Nome completo</label>
                    <div class="relative">
                ...
                {{-- Confirmar Senha --}}
                <div class="flex flex-col gap-1.5">
                    <label class="text-sm font-semibold" style="color: #1a2e1a; font-family: 'Georgia', serif;">Confirmar senha</label>
                    <div class="relative">
                        <svg class="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 pointer-events-none" style="color: #8a7a6b;" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <rect x="3" y="11" width="18" height="11" rx="2"/>
                            <path d="M7 11V7a5 5 0 0110 0v4"/>
    ...
    >
        <div class="flex flex-col items-center gap-4">
            ...
            <div class="text-center">
                <p class="font-bold text-white text-lg" style="font-family: 'Georgia', serif;">Criando sua conta...</p>
