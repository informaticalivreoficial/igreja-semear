    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col justify-between p-12"
        ...
        <div class="relative z-10">
            ...
            <h2 class="text-4xl font-bold text-white mb-4 leading-tight" style="font-family: 'Georgia', serif;">
                Renove sua<br>
                <span style="color: #c4a84a;">jornada</span>
            </h2>
            <p class="text-base leading-relaxed" style="color: rgba(255,255,255,0.6); max-width: 320px; font-style: italic;">
                ...
                <span class="text-xs" style="color: rgba(196,168,74,0.5);">Apocalipse 21:5</span>
            </p>
        ...
        <div class="relative z-10">
            <p class="text-xs" style="color: rgba(255,255,255,0.2);">
                © {{ date('Y') }} Comunidade Cristã EMEAR - Todos os direitos reservados
            </p>
        </div>
    </div>
        ...
        <div class="w-full max-w-md">
            ...
            @if($success)
                <div class="flex items-start gap-3 px-4 py-3 rounded-xl mb-6" style="background: rgba(35,197,94,0.08); border: 1px solid rgba(35,197,94,0.2);">
                    ...
                    <div>
                        <p class="text-sm font-semibold" style="color: #15803d;">Senha redefinida com sucesso!</p>
                        <p class="text-xs mt-1" style="color: #15803d;">Agora você pode fazer login com sua nova senha.</p>
                    </div>
                </div>
            @endif
            ...
            @if ($errors->any())
                <div class="flex items-start gap-3 px-4 py-3 rounded-xl mb-6" style="background: rgba(180,60,60,0.08); border: 1px solid rgba(180,60,60,0.2);">
                    ...
                    <div>
                        <p class="text-sm font-semibold" style="color: #b43c3c;">Erro ao redefinir senha</p>
                        <p class="text-xs mt-1" style="color: #b43c3c;">Por favor, verifique os campos abaixo.</p>
                    </div>
                </div>
            @endif
            ...
            <form wire:submit="resetPassword" class="space-y-4">
                ...
                <div class="flex flex-col gap-1.5">
                    <label class="text-sm font-semibold" style="color: #1a2e1a; font-family: 'Georgia', serif;">
                        Nova senha
                    </label>
                    <div class="relative">
                    ...
                    @enderror
                    <p class="text-xs" style="color: #8a7a6b;">Mínimo 8 caracteres com letras e números</p>
                </div>
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <div class="relative">
                        <svg class="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 pointer-events-none" style="color: #8a7a6b;" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <rect x="3" y="11" width="18" height="11" rx="2"/>
                            <path d="M7 11V7a5 5 0 0110 0v4"/>
                            <path d="M12 15l-2-2M12 15l2-2M12 15v3"/>
                        </svg>
                        <input
                            type="password"
                ...
                <div class="flex items-start gap-2 p-3 rounded-lg" style="background: rgba(196,168,74,0.05); border: 1px solid rgba(196,168,74,0.1);">
                    ...
                    <div>
                        <p class="text-xs font-semibold" style="color: #1a2e1a;">Sua senha deve conter:</p>
                        <ul class="text-xs mt-1" style="color: #8a7a6b;">
                            <li class="flex items-center gap-1">• Mínimo 8 caracteres</li>
                            <li class="flex items-center gap-1">• Pelo menos uma letra maiúscula</li>
                            <li class="flex items-center gap-1">• Pelo menos um número</li>
                            <li class="flex items-center gap-1">• Caractere especial (opcional)</li>
                        </ul>
                    </div>
                </div>
    ...
    >
        <div class="flex flex-col items-center gap-4">
            ...
            <div class="text-center">
                <p class="font-bold text-white text-lg" style="font-family: 'Georgia', serif;">Redefinindo senha...</p>
