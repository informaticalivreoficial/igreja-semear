...
<body>
    <div class="box">
        <div class="icon">
            <svg width="40" height="40" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
        </div>
        <div class="code">429</div>
        <h1>Muitas solicitações</h1>
        <p>Você fez muitas solicitações em um curto período. Aguarde alguns instantes e tente novamente.</p>
