        ...
        <div class="container-site flex flex-col gap-8 lg:flex-row">
            ...
            <div class="min-w-0 flex-1">
                @forelse($avisos as $aviso)
                    <article id="aviso-{{ $aviso->id }}" class="mb-5 overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-sm">
                        @if($aviso->cover)
                        ...
                        <div class="p-6">
                            ...
                            <h2 class="font-display mt-2 text-xl font-bold text-slate-900">{{ $aviso->title }}</h2>
                ...
                @empty
                    <div class="rounded-2xl border border-slate-100 bg-white p-12 text-center shadow-sm">
                        <p class="font-display text-xl font-bold text-slate-900">Nenhum aviso no momento</p>
